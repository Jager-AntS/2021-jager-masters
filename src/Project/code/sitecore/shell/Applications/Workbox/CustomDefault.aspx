      ...
      <div class="scFlexContent">
        ...
        <div class="scPanel " style="position: absolute;">
            ...
            <div id="WorkboxFrame" class="" style="height: 100%">
                <!--Extended sitecore workflow by custom workbox -->
              <iframe title="Workbox" src="/sitecore/shell/default.aspx?xmlcontrol=CustomWorkbox&mo=preview" style="width: 100%;height: 100%; box-sizing: border-box;"></iframe>
            </div>
